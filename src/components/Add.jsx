...
const Add = () => {
    ...
    return (
        ...
        <Modal open={open} className={classes.modalWrap}>
            <Container className={classes.container}>
                <form className={classes.form} autoComplete="off">
                    ...
                    <div className={classes.item}>
                        <TextField id="standard-basic" multiline rows={4} defaultValue="Tell your story..." variant="outlined" label="Description" size="small" style={{width:"100%"}}/>
                    </div>
                    <div className={classes.item}>
